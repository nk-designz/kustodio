...
impl LockEvent {
    ...
    // .api.messages.LockEvent.Status status = 2;
...
pub struct PeersResponse {
    // message fields
    pub peers: ::std::vec::Vec<::protobuf::Chars>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl PeersResponse {
    ...
    pub fn get_peers(&self) -> &[::protobuf::Chars] {
        &self.peers
    }
    ...
    // Param is passed by value, moved
    pub fn set_peers(&mut self, v: ::std::vec::Vec<::protobuf::Chars>) {
        self.peers = v;
    }

    // Mutable pointer to the field.
    pub fn mut_peers(&mut self) -> &mut ::std::vec::Vec<::protobuf::Chars> {
        &mut self.peers
    }

    // Take field
    pub fn take_peers(&mut self) -> ::std::vec::Vec<::protobuf::Chars> {
...
impl ::protobuf::Message for PeersResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_carllerche_string_into(wire_type, is, &mut self.peers)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl ListResponse {
    ...
    // repeated .api.messages.ListResponse.Lock locks = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\tweb.proto\x12\x0capi.messages\"!\n\x0bLockRequest\x12\x12\n\x04name\
    \x18\x01\x20\x01(\tR\x04name\"\x07\n\x05Empty\"F\n\x0cLockResponse\x12\
    \x16\n\x05error\x18\x01\x20\x01(\tH\0R\x05error\x12\x16\n\x05state\x18\
    \x02\x20\x01(\x08H\0R\x05stateB\x06\n\x04body\"\x95\x01\n\tLockEvent\x12\
    \x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x126\n\x06status\x18\x02\x20\
    \x01(\x0e2\x1e.api.messages.LockEvent.StatusR\x06status\"<\n\x06Status\
    \x12\x0b\n\x07Created\x10\0\x12\x0b\n\x07Removed\x10\x01\x12\x0c\n\x08Un\
    locked\x10\x02\x12\n\n\x06Locked\x10\x03\"%\n\rPeersResponse\x12\x14\n\
    \x05peers\x18\x01\x20\x03(\tR\x05peers\"w\n\x0cListResponse\x125\n\x05lo\
    cks\x18\x01\x20\x03(\x0b2\x1f.api.messages.ListResponse.LockR\x05locks\
    \x1a0\n\x04Lock\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12\x14\n\
    \x05state\x18\x02\x20\x01(\x08R\x05stateb\x06proto3\
";
